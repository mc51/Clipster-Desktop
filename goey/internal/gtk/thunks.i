...
extern void windowSetLayoutSize(void* window, unsigned width, unsigned height);
...
extern void dialogAddFilter(void* dialog, char const* name, char const* pattern);
extern unsigned dialogResponseAccept(void);
extern unsigned dialogResponseCancel(void);

extern void* mountMessageDialog(void* window, char const* title, unsigned icon, char const* text );
...
extern void* mountOpenDialog(void * window, char const* title, char const* filename );
extern void* mountSaveDialog(void * window, char const* title, char const* filename );
...
extern void *mountCheckbox(void *container, bool value, char const *text, bool disabled,
                           bool onchange, bool onfocus, bool onblur);
extern void checkboxUpdate(void *button, bool value, char const *text, bool disabled,
                           bool onchange, bool onfocus, bool onblur);
...
extern void *mountTextarea(void *container, char const *text,
                           bool disabled, bool readonly,
                           bool onchange, bool onfocus,
                           bool onblur);
extern void textareaUpdate(void *widget, char const *text,
                           bool disabled, bool readonly,
                           bool onchange, bool onfocus,
                           bool onblur);
%newobject textareaText;
...
extern void *mountSlider(void *container, double value, bool disabled, double min, double max, bool onchange, bool onfocus, bool onblur);
extern void sliderUpdate(void *widget,double value, bool disabled, double min, double max, bool onchange, bool onfocus, bool onblur);
...
extern void *mountDecoration(void *parent, unsigned fill, unsigned stroke, int radius );
extern void decorationUpdate(void *widget, unsigned fill, unsigned stroke, int radius );
...
extern void *mountCombobox(void *parent, char const* items, int value, bool unset, bool disabled,
		bool onchange, bool onfocus, bool onblur);
extern void comboboxUpdate(void *widget, char const* items, int value, bool unset, bool disabled,
		bool onchange, bool onfocus, bool onblur);
