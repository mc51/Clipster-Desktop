...
func Encrypt(user string, pw string, text string, iters int) string {
	// Encrypt the password using Fernet and a key generated by deriveKey() and return it as string
...
func Decrypt(text string, iters int) string {
	// Decrypt decrypts a text using hash_login as a key and Fernet and returns a string
